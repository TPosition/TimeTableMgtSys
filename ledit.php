...
$query = "SELECT * FROM `$username` WHERE $username.Code='$Code'";
...
<div class="wrapper">
<div class="form">
<center><a style="text-decoration: none; " class="abutton button" href="insert.php">Insert Records (Student)</a> | 
...
$update="UPDATE `$username` SET `Code`='".$Code."', `Name`='".$Name."', `Start`='".$Start."', `End`='".$End."', `Day`='".$Day."',`Venue`='".$Venue."' WHERE $username.Code='$oriCode'";

mysqli_query($con, $update) or die(mysqli_error());
$status = "Record Updated Successfully. </br></br><a href='lview.php?username=$username'>View Updated Record</a>";
echo '<p style="color:#FF0000;">'.$status.'</p>';
}
	else {
		$status = "The value of start time is higher than end time, please try again. </br></br><a href='ledit.php?Code=$oriCode&username=$username'>Return To View Record</a>";
		echo '<p style="color:#FF0000;">'.$status.'</p>';
	}
}
	else{
		echo "<p style='color:#FF0000;'>$clashErr<br>Please Try Again.<br><a href='ledit.php?Code=$oriCode&username=$username'>Return To Edit Record</a></p>";
	}
}else {
?>
<div>
...
<p style="left:1px; position:relative;">Start Time :<select name="Stime" class="select-style" style="">
...
<div style="left:3px; position:relative;"><p>End Time :<select name="Etime" class="select-style" style="">
...
<p style="left:20px; position:relative;">Day :<select name="Dname" class="select-style" style="">
...
<p style="left:13px; position:relative;">Venue :<select name="Vname" class="select-style" style="">
...
<?php  echo "<a href='lview.php?username=$username'>Back</a>" ?>
</center>
<?php } ?>
